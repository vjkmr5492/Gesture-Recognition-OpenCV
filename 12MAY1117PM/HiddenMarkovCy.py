...
cdef class HiddenMarkov:
    ...
    cdef public np.ndarray[np.float64_t, ndim=2] transition
    cdef public np.ndarray[np.float64_t, ndim=2] output
    cdef public np.ndarray[np.float64_t, ndim=1] pi
    cdef public np.ndarray[np.float64_t, ndim=1] scaleFactor
    ...
    def setTrainSeq(self, trainSeq):
        ...
        self.num_obSeq = trainSeq.shape[0]
        # print trainSeq[1]
